...
overall_grade = round(((lab_percent * 20) + (activity_percent * 15) + (assignment_1 * 4) + (assignment_2 * 4) + (assignment_3 * 4) + (assignment_4 * 4) + (midterm_1 * 12.5) + (midterm_2 * 12.5) + (final_exam * 18) + (midterms_and_final_prep * 6)) / 100)
